...
export function ShortFormReviewLayout() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 min-w-0 overflow-hidden">
      ...
      {/* Main content: timelines on left, canvas on right */}
      <div className="flex-1 flex flex-row min-h-0 min-w-0">
        {/* Left: Keyframe Overview (top) + Review Timeline (bottom) */}
        <div className="flex flex-col min-h-0 min-w-0" style={{ width: '65%' }}>
          {/* Top: Audio Meter + Keyframe Overview */}
          <div className="flex flex-row min-h-0 min-w-0 flex-1">
        ...
        {/* Right 35%: Canvas (full height) */}
        <div className="flex-shrink-0 min-h-0 min-w-0 border-l border-hairline" style={{ width: '35%' }}>
