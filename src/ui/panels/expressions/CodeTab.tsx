...
const REFERENCE_ITEMS = [
  ...
  { name: 'loopOut(type)', desc: 'Loop after last key: cycle / pingpong / continue / offset', example: 'loopOut("offset")' },
  { name: 'loopIn(type)', desc: 'Loop before first key: cycle / pingpong / continue / offset', example: 'loopIn("pingpong")' },
  ...
  { name: 'bounce(freq, decay, amp)', desc: 'Inertial overshoot after the last keyframe', example: 'bounce(2.5, 4, 0.1)' },
  { name: 'valueAtTime(t)', desc: 'Sample this property at time t (seconds)', example: 'valueAtTime(time - 0.2)' },
  { name: 'delay(sec)', desc: 'This property, sec seconds ago (lag / follow)', example: 'delay(0.15)' },
  { name: 'posterizeTime(rate)', desc: 'Stepped time; feed to valueAtTime', example: 'valueAtTime(posterizeTime(12))' },
