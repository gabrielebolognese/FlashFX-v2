      ...
      <div className="px-3 py-2 space-y-3">
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-1 px-2 py-1.5 rounded text-[10px] transition-colors ${
                    active
                      ...
                      : 'bg-surface-1 text-slate-400 border border-hairline hover:border-slate-500'
                  }`}
                >
                  <opt.icon size={11} />
                  {opt.label}
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <input
                ...
                className="w-full bg-surface-1 border border-hairline rounded px-2 py-1 text-[11px] text-slate-200 focus:border-cyan-500/50 focus:outline-none"
              />
            </div>
            <div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-surface-1 border border-hairline rounded px-2 py-1.5 text-[11px] text-slate-200 focus:border-cyan-500/50 focus:outline-none"
          >
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="w-14 bg-surface-1 border border-hairline rounded px-2 py-1 text-[11px] text-slate-200 text-right focus:border-cyan-500/50 focus:outline-none"
            />
          </div>
        </div>
        ...
        <button
          ...
          className={`w-full flex items-center justify-between px-2 py-1.5 rounded text-[10px] transition-colors border ${
            layer.followPathRotation
              ...
              : 'bg-surface-1 text-slate-400 border-hairline hover:border-slate-500'
          }`}
          title="Rotate children to follow the container path's local tangent"
        >
          <span>Follow Path Rotation</span>
          <span className={`w-7 h-3.5 rounded-full relative transition-colors ${layer.followPathRotation ? 'bg-cyan-500/50' : 'bg-surface-4'}`}>
        ...
        {/* Children count */}
        <div className="bg-surface-1 border border-hairline rounded p-2 flex items-center justify-between">
