...
function ResizeTooltip({
  ...
  return (
    <div
      className="fixed z-modal pointer-events-none px-2 py-1 rounded-md bg-[#0e1c32]/95 border border-hairline shadow-overlay text-[10px] font-mono tabular-nums whitespace-nowrap"
      style={{
