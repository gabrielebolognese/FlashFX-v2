...
export type PatternType = 'waves' | 'plasma' | 'kaleidoscope' | 'mosaic';
...
export const PATTERN_TYPES: PatternType[] = ['waves', 'plasma', 'kaleidoscope', 'mosaic'];
...
export const PATTERN_TYPE: Record<PatternType, number> = { waves: 0, plasma: 1, kaleidoscope: 2, mosaic: 3 };
